...
another='fritz.heidi@gmail.com'   ### Another recipient ####
msg = email.mime.Multipart.MIMEMultipart()
msg['Subject'] = 'From Pi'
msg['From'] = me
msg['To'] = you
body=email.mime.Text.MIMEText("This is from Heidi's Pi\n"+strftime("%Y-%m-%d %H:%M:%S"))

## Attaching files/images that are in the directory
#part = MIMEBase('application',"octet-stream")
#part.set_payload(open("LEDsetup.JPG", "rb").read())
#Encoders.encode_base64(part)

#part.add_header('Content-Disposition', 'attachment; filename="LEDsetup.JPG"')
